...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li id="username">您好，欢迎来到京西！[<a href="/member/login">登录</a>] [<a href="/member/register">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<script type="text/javascript">
    $.getJSON('http://www.yiishop.com/member/user-info',function(date){
        if(date.isGuest==false){
            //更新用户栏信息
            $("#username").html('您好，欢迎来到京西！[<a href="/member/logout">'+date.username+'退出</a>] [<a href="/member/register">免费注册</a>]')
        }
    });
</script>
</body>
